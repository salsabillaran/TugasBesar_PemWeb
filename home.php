...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="src/style/imgs//favicon.ico" type="image/x-icon">
    <link rel="apple-touch-icon" href="src/style/imgs//apple-touch-icon.png">
	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-center">
				<img src="src/style/imgs/slider-02.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Rumah Makan <br> Masakan Padang</strong></h1>
						</div>
					</div>
				</div>
			</li>
			...
			<div class="tz-gallery">
				<div class="row">
					<div class="col-sm-12 col-md-4 col-lg-3">
						<a class="lightbox" href="src/style/imgs/gallery-img-01.jpg">
							<img class="img-fluid" src="src/style/imgs/gallery-img-01.jpg" alt="Galeri Images">
						</a>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-3">
						<a class="lightbox" href="src/style/imgs/gallery-img-02.jpg">
							<img class="img-fluid" src="src/style/imgs/gallery-img-02.jpg" alt="Galeri Images">
						</a>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-3">
						<a class="lightbox" href="src/style/imgs/gallery-img-03.jpg">
							<img class="img-fluid" src="src/style/imgs/gallery-img-03.jpg" alt="Galeri Images">
						</a>
					</div>
					<div class="col-sm-12 col-md-4 col-lg-3">
						<a class="lightbox" href="src/style/imgs/gallery-img-04.jpg">
							<img class="img-fluid" src="src/style/imgs/gallery-img-04.jpg" alt="Galeri Images">
						</a>
					</div>
				</div>
			</div>
						...
						<div class="carousel-inner mt-4">
							<div class="carousel-item text-center active">
								<div class="img-box p-1 border rounded-circle m-auto">
									<img class="d-block w-100 rounded-circle" src="src/style/imgs/placeholder.png" alt="">
								</div>
